  ...
  render() {
    ...
    return (
      <div className="Camera">
        {playerORImage}
        <div className="camera__bg">
        <button className="img__btn" onClick={this.initializeMedia}>Take Photo</button>
        <button className="img__btn" onClick={this.capturePicture}>Capture</button>
        <button className="img__btn" onClick={this.switchCamera}>Switch</button>
        </div>
      </div>
    );
  }
